    ...
    return (
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
                ...
                <input type="email" placeholder="Digite seu melhor email" className="rounded-lg py-2 px-2 text-sm placeholder:text-stone-400"
            ...
            <button type="submit" className="bg-slate-600 hover:bg-slate-500 font-medium trxt-sm py-2 px-4 rounded-lg text-white">Cadastrar</button>
        </form>
    )
}
